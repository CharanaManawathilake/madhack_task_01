// ignore_for_file: camel_case_types, use_key_in_widget_constructors, avoid_unnecessary_containers, prefer_const_constructors, prefer_const_literals_to_create_immutables
...
class _loginPageClassState extends State<loginPageClass> {
  ...
  void signin() async {
    ...
    var url = Uri.http(ApiEndPoints.baseUrl, ApiEndPoints.authEndpoints.signin);
